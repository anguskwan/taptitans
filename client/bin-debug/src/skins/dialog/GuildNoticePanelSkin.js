...
(function (skins) {
    var dialog;
    (function (dialog) {
        var GuildNoticePanelSkin = (function (_super) {
            __extends(GuildNoticePanelSkin, _super);
            function GuildNoticePanelSkin() {
                _super.call(this);
            ...
            var __egretProto__ = GuildNoticePanelSkin.prototype;
            Object.defineProperty(__egretProto__, "skinParts", {
                get: function () {
                    return GuildNoticePanelSkin._skinParts;
                },
                enumerable: true,
                configurable: true
            });
            ...
            __egretProto__.titleLbl_i = function () {
                var t = new egret.gui.Label();
                this.titleLbl = t;
                this.__s(t, ["bold", "fontFamily", "size", "text", "x", "y"], [true, "Arial", 24, "公告", 29, 26]);
                return t;
            };
            GuildNoticePanelSkin._skinParts = ["titleLbl", "textInput", "closeBtn", "rightBtn"];
            return GuildNoticePanelSkin;
        })(egret.gui.Skin);
        dialog.GuildNoticePanelSkin = GuildNoticePanelSkin;
        GuildNoticePanelSkin.prototype.__class__ = "skins.dialog.GuildNoticePanelSkin";
