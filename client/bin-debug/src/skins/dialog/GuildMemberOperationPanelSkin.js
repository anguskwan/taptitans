...
(function (skins) {
    var dialog;
    (function (dialog) {
        var GuildMemberOperationPanelSkin = (function (_super) {
            __extends(GuildMemberOperationPanelSkin, _super);
            function GuildMemberOperationPanelSkin() {
                _super.call(this);
            ...
            var __egretProto__ = GuildMemberOperationPanelSkin.prototype;
            Object.defineProperty(__egretProto__, "skinParts", {
                get: function () {
                    return GuildMemberOperationPanelSkin._skinParts;
                },
                enumerable: true,
                configurable: true
            });
            ...
            __egretProto__.__12_i = function () {
                ...
                this.__s(t, ["bold", "fontFamily", "horizontalCenter", "size", "text", "touchEnabled", "verticalCenter"], [true, "Arial", 0, 20, "删除", false, 0]);
                return t;
            };
            ...
            __egretProto__.__6_i = function () {
                var t = new egret.gui.Label();
                this.__s(t, ["bold", "fontFamily", "size", "text", "x", "y"], [true, "Arial", 24, "请选择操作", 26, 25]);
                return t;
            };
            ...
            __egretProto__.__10_i = function () {
                var t = new egret.gui.Label();
                this.__s(t, ["bold", "fontFamily", "horizontalCenter", "size", "text", "touchEnabled", "verticalCenter"], [true, "Arial", 0, 20, "提升会长", false, 0]);
                return t;
            };
            GuildMemberOperationPanelSkin._skinParts = ["closeBtn", "iconImg", "nameLbl", "highestStageLbl", "attLbl", "currLbl", "approveBtn", "rejectBtn"];
            return GuildMemberOperationPanelSkin;
        })(egret.gui.Skin);
        dialog.GuildMemberOperationPanelSkin = GuildMemberOperationPanelSkin;
        GuildMemberOperationPanelSkin.prototype.__class__ = "skins.dialog.GuildMemberOperationPanelSkin";
