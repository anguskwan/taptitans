...
var GameUI = (function (_super) {
    ...
    __egretProto__.showBoardPanel = function () {
    ...
    __egretProto__.showValidateLayer = function () {
    ...
    __egretProto__.showGetMoneyAni = function (type) {
        if (type == "relic") {
            ...
            egret.Tween.get(group).to({ x: 5 }, 300).wait(2000).to({ x: -(20 * _.size(num) + 60) }, 200).call(function () {
    ...
    __egretProto__.showToastLayer = function (obj) {
        if (obj && obj.data) {
    ...
    __egretProto__.getGuildLvUpSource = function (type) {
        var source = {
            1: {
                title: "扩充成员",
    ...
    __egretProto__.getGuildTypeSource = function (type) {
        var source = {
            "1": {
                title: "金币灿烂",
                desc: "可收到%s块黄金",
    ...
    */
    __egretProto__.getEveryDayReward = function (day) {
        var elementSource = {
            1: {
                type: "diamond",
                num: 50
    ...
    __egretProto__.getElementTypeSource = function (type) {
    ...
    __egretProto__.getGuildGoldSource = function (id) {
        var source = {
            1: {
                name: "白羊座",
                time: [9, 10]
    ...
    __egretProto__.getEquipTypeToName = function (type) {
        var name = ["", "weapon", "mantle", "headpiece", "wing", "armor", "sword"];
        return name[type];
    };
    __egretProto__.getEquipSkillColor = function (skill) {
        var color;
        switch (skill) {
            case 1:
                color = 0xee9f41;
