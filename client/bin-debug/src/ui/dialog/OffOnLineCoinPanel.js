 ...
 *
 */
var OffOnLineCoinPanel = (function (_super) {
    __extends(OffOnLineCoinPanel, _super);
    function OffOnLineCoinPanel() {
        _super.call(this);
        this.skinName = skins.dialog.OffOnLineCoinPanelSkin;
    }
    var __egretProto__ = OffOnLineCoinPanel.prototype;
    ...
    return OffOnLineCoinPanel;
})(egret.gui.SkinnableContainer);
OffOnLineCoinPanel.prototype.__class__ = "OffOnLineCoinPanel";
