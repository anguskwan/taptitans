...
var Channel = function(hub) {
    ...
    this.client = new OAuth(this.appid, this.appSecret, this.hub.funs[this.name].getUserAccessToken, this.hub.funs[this.name].saveUserAccessToken);
    this.api = new API(this.appid, this.appSecret, this.hub.funs[this.name].getAccessToken, this.hub.funs[this.name].saveAccessToken);
    this.api.registerTicketHandle(this.hub.funs[this.name].getTicketToken, this.hub.funs[this.name].saveTicketToken);
 ...
 * @param style
 */
Channel.prototype.getAuthorizeURL = function(redirect, authInfo, style){
    return this.client.getAuthorizeURL(sysutil.format("%s?scode=%s&channel=%s&shareCode=%s", redirect, authInfo.scode || "", authInfo.channel || this.name, authInfo.shareCode || ""), '', !!style ? style : 'snsapi_base');
};
