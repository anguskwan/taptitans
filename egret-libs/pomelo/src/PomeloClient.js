...
(function(root, ByteArray) {
  ...
  Protocol.strencode = function(str) {
    ...
    (function(exports, module) {
        ...
        var byteCount;
        var byteIndex;
        window.utf8decode = function(byteArray2) {
            byteArray = ucs2decode(byteArray2);
   ...
   */
    Protocol.strdecode = window.utf8decode;
